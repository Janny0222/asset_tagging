import { TableName } from "./definition"
...
export const tableName: TableName[] = [
        ...
        {name: 'steniel_inventory', accounts: 'steniel_accounts',company: 'Steniel Manufacturing Corporation', table: 'steniel_mobile_inventory', displayName: "STN"},   
        {name: 'baling_inventory', accounts: 'baling_accounts',company: 'Baling Station', table: 'baling_mobile_inventory', displayName: "BALING"},   
    ]
