...
import { transferCellphoneInventory } from '@/services/Cellphone/cellphoneService'

const TransferCellphoneDataModal = ({modalOpen, setModalOpen, id} : ChildrenModalProps) => {
    const { tableData } = useCompanyContext()
    ...
    const handleTransferSubmit = async () => {
        try {
            const res = await transferCellphoneInventory(id, formData);
...
export default TransferCellphoneDataModal