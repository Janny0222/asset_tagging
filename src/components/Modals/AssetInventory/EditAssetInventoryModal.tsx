...
const EditAssetInventoryModal = ({modalOpen, setModalOpen, id} : ChildrenModalProps ) => {
  ...
  return (
    <>
    <TransferAssetDataModal modalOpen={transferData} setModalOpen={setTransferData}/>
            ...
            <form onSubmit={handleSubmit} className='grid grid-cols-8 gap-6 text-left mt-6'>
              ...
              <div className='col-span-8 grid grid-cols-5 gap-2'>
                  <div className='col-span-3 flex flex-col gap-1'>
                      <InputDate name='date_deployed' disabled={status !== 'active'} label={'Date Deployed'} value={formData?.date_deployed || ''} navbar type="date" bg={false} onChange={handleChange} />
                      {status !== 'active' && (
