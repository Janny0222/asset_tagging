...
export default function StatusToggle({  onChange} : {  onChange: () => void}){
    ...
    <div className="flex items-center flex-col-reverse  me-5">
        ...
        <label
                ...
                className={`cursor-pointer relative w-14 h-6  rounded-full p-1 transition-colors duration-200 ease-in-out ${toggle === 'inactive' ? 'bg-red-500' : 'bg-green-500'}`}
            >
                <span
