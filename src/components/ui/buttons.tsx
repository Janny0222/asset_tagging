...
export function ArchiveInventory({ onClick}: {onClick: () => void}) {
  return (
    <>
      <button onClick={onClick} aria-label="Delete item" className="bg-dry text-red-600 rounded flex-colo w-6 h-6">
        <MdDelete />
      </button>
    </>
  )
