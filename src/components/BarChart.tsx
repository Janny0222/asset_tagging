...
const fetchData = async () => {
    try {
        let get_date;
      const [gpcDesktop, gpcLaptop, gpcMac, gpcMobile, lsiDesktop, lsiLaptop, lsiMac, lsiMobile, gkcDesktop, gkcLaptop, gkcMac, gkcMobile, gsrcDesktop, gsrcMac, gsrcLaptop] = await Promise.all([
...
const options = {
 ...
 const data = {
    ...
    datasets: [
        ...
        {
            label: 'MOBILE',
            data: [gpcMobileToCount, lsiMobileToCount, gkcMobileToCount],
